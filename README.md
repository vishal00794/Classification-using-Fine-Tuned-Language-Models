...
A pretrained **LLaMA 3.2** model was used directly for SMS classification without any task-specific training. The model relied entirely on its general language understanding to predict whether a message was spam or ham.
...
Fine-tuning improved classification accuracy by **5%** on the same test data, demonstrating the effectiveness of domain adaptation.

---

## Key Takeaways

- Fine-tuning significantly improves performance over zero-shot inference  
